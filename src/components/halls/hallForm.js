            ...
            <div class="w-full lg:w-1/2">
              ...
              <div>
                ...
                <Link to="/profile" ><button
                  class="w-full lg:w-auto my-4 rounded-md px-1 sm:px-16 py-5 bg-rose-900 text-white hover:bg-rose-900 focus:outline-none focus:ring-2 focus:ring-rose-900 focus:ring-opacity-50">Verify Email
                </button>
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-screen-md mx-auto p-5 my-10 bg-white shadow-2xl shadow-blue-200">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
              Create  <span className="text-rose-900">Hall </span>
            </h3>
          </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="flex justify-between w-full px-3">
                ...
                // onClick={() => setShowModal(true)}
                  onClick={CreateHall}
                  className="shadow bg-rose-900 hover:bg-rose-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                  type="submit"
                >
                  Create
                </button>
