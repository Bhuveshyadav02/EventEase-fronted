...
import verisuccess from '../../images/verification success.jpg'
import verifail from  "../../images/verification fail.png"
const VerifySuccess = () => {
...
//consolelog(authStatus);
  const userValid = async () => {
    ...
    const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/${id}/${token}`, {
